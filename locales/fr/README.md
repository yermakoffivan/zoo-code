...
- **Améliorations de l'indexation du code dans Semble v0.4.1** — l'analyse aplatie des résultats et les messages d'état localisés rendent les résultats d'indexation et les retours d'état plus fiables
- **Correctifs de fiabilité pour les tâches et la délégation** — les garde-fous de transition d'état, la réconciliation de délégation au démarrage et la réouverture atomique de la tâche parente réduisent les changements d'état de tâche invalides et les problèmes de transfert de délégation
