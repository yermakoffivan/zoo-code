...
> Roo 팀 🦘🦘🦘의 [최근 발표](https://x.com/mattrubens/status/2046636598859559114)를 보셨을지도 모릅니다. 요약하면, 그들은 Roo 개발을 정리하고 다른 제품인 [Roomote](https://roomote.dev/)에 집중하려고 합니다. 이 소식은 Roo 사용자였던 우리에게 힘들게 다가왔고, 이 플러그인은 우리 모두에게 정말 큰 의미가 있습니다.
>
> 이 플러그인에 쏟아 준 놀라운 노력에 대해 Roo 팀 전체에 감사해야 합니다. 여기서 한 사람씩 이름을 부르지는 않겠지만, 모두가 그들이 훌륭한 개발자들이고, 그만큼 훌륭한 사람들이라는 데 동의할 거라고 생각합니다. Roo 팀에 감사드립니다.
>
...
- 채팅에서 이전 checkpoint 로 이동하는 탐색 컨트롤을 추가했어요.

**v3.54.0에 곧 추가될 예정:**

- 동적 모델 가져오기를 포함한 DeepSeek V4 지원.
- MCP OAuth 클라이언트 지원.
