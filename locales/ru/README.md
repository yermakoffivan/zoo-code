...
- **Обновление до Semble v0.4.1** — плоский разбор результатов и локализованные сообщения о статусе
- **Страж перехода состояния жизненного цикла задач** — новый страж перехода состояния и согласование делегирования при запуске предотвращают недопустимые переходы состояния задач
