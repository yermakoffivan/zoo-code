...
- **Discord:** Присоединяйся к нашему [Discord](https://discord.gg/SfHYG44NUA).
...
- **Хотите над этим поработать?** Напишите комментарий «Забираю» к задаче и напишите личное сообщение основной команде в [Discord](https://discord.gg/SfHYG44NUA), чтобы вас назначили. Назначение будет подтверждено в ветке.
...
- Должен ссылаться на назначенную задачу GitHub. Чтобы вас назначили: напишите комментарий «Забираю» к задаче и напишите личное сообщение основной команде в [Discord](https://discord.gg/SfHYG44NUA). Назначение будет подтверждено в ветке.
