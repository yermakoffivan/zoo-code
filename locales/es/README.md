<p align="center">
        ...
        <p align="center">
          <em>Obtén ayuda rápido → <a href="https://discord.gg/SfHYG44NUA">Únete a Discord</a> • ¿Prefieres algo asíncrono? → <a href="https://www.reddit.com/r/ZooCode/">Únete a r/ZooCode</a></em>
        </p>
...
> Puede que hayas visto el [anuncio reciente](https://x.com/mattrubens/status/2046636598859559114) del equipo de Roo 🦘🦘🦘. El resumen es que están retirando Roo para trabajar en otro producto, [Roomote](https://roomote.dev/). La noticia fue dura para quienes usamos Roo; este plugin significa muchísimo para todos nosotros.
>
> Tenemos que dar las gracias a todo el equipo de Roo por el trabajo increíble que hicieron con este plugin. No vamos a nombrarlos uno por uno aquí, pero creo que todos estamos de acuerdo en que son desarrolladores increíbles y, tan importante como eso, personas increíbles. Gracias al equipo de Roo.
>
...
Zoo Code se adapta a tu forma de trabajar, no al revés:
...
- **[Servidor de Discord](https://discord.gg/SfHYG44NUA):** Únete a la comunidad para obtener ayuda y discutir en tiempo real.
...
- **[Solicitudes de funcionalidades](https://github.com/Zoo-Code-Org/Zoo-Code/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop):** ¿Tienes una idea? Compártela con los desarrolladores.
...
Presiona `F5` (o ve a **Ejecutar** → **Iniciar depuración**) en VSCode. Esto abrirá una nueva ventana de VSCode con la extensión Zoo Code en ejecución.
...
1.  Primero, construye el paquete VSIX:
    ...
    pnpm vsix
    ```
2.  Se generará un archivo `.vsix` en el directorio `bin/` (p. ej., `bin/zoo-code-<version>.vsix`).
...
**¡Disfruta Zoo Code!** Tanto si lo llevas con la correa corta como si lo dejas deambular de forma autónoma, estamos deseando ver lo que construyes. Si tienes preguntas o ideas de funciones, abre una [issue](https://github.com/Zoo-Code-Org/Zoo-Code/issues) o inicia una [discussion](https://github.com/Zoo-Code-Org/Zoo-Code/discussions). ¡Feliz código!
